...
-- Tabla de usuarios (custom, no confundir con auth.users)
...
-- Tabla de comercios (sin user_id directo; la relacion se da via users_x_comercios)
...
-- Tabla puente: relacion users <-> comercios con rol
CREATE TABLE IF NOT EXISTS users_x_comercios (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
